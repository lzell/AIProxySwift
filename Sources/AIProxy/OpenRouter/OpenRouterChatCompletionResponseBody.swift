...
extension OpenRouterChatCompletionResponseBody.Choice {
    public struct Message: Decodable {
        ...
        public init(content: String?, reasoning: String?, role: String?, toolCalls: [ToolCall]?, annotations: [Annotation]? = nil) {
...
extension OpenRouterChatCompletionResponseBody.Choice.Message {
    public struct Annotation: Decodable {
        /// The type of annotation (typically "url_citation" for web search results)
        ...
        public init(type: String, urlCitation: URLCitation?) {
            self.type = type
...
extension OpenRouterChatCompletionResponseBody.Choice.Message {
    public struct URLCitation: Decodable {
        ...
        public init(url: String, title: String?, content: String?, startIndex: Int?, endIndex: Int?) {
            self.url = url
            self.title = title
            self.content = content
