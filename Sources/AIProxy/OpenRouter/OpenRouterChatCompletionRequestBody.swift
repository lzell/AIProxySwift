...
extension OpenRouterChatCompletionRequestBody {
    nonisolated public enum Message: Encodable, Sendable {
        ...
        ///   - toolCalls: Tool calls generated by the model. Include these when resending conversation history
        ///                so OpenRouter can pair them with subsequent `tool` role results.
        case assistant(
            content: AssistantContent? = nil,
            name: String? = nil,
        ...
        /// - Parameters:
        ///   - content: The tool's result payload.
...
extension OpenRouterChatCompletionRequestBody.Message {
    nonisolated public struct ToolCall: Encodable, Sendable {
        ...
        /// The type of tool call. OpenRouter currently supports function calls.
        public let type = "function"

        /// The function that the model asked to call.
        public let function: Function

        public init(
            id: String,
            function: OpenRouterChatCompletionRequestBody.Message.ToolCall.Function
        ) {
            self.id = id
...
extension OpenRouterChatCompletionRequestBody.Message.ToolCall {
    nonisolated public struct Function: Encodable, Sendable {
        /// The name of the function that the model asked to call.
