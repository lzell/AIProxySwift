...
public struct OpenRouterChatCompletionRequestBody: Encodable, Sendable {
    // Required
...
extension OpenRouterChatCompletionRequestBody {
    public enum Route: String, Encodable, Sendable {
        case fallback
    }
}
...
extension OpenRouterChatCompletionRequestBody.Message {
    ...
    public enum AssistantContent: Encodable, Sendable {
        case text(String)
...
extension OpenRouterChatCompletionRequestBody.Message {
    ...
    public enum SystemContent: Encodable, Sendable {
        case text(String)
...
extension OpenRouterChatCompletionRequestBody {
    ...
    public struct ProviderPreferences: Encodable, Sendable {
        public enum Quantization: String, Encodable, Sendable {
            case int4 = "int4"
            case int8 = "int8"
            case fp6 = "fp6"
            case fp8 = "fp8"
