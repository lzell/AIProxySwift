...
internal struct AnthropicMessageStreamingDeltaBlock: Decodable, Sendable {
...
extension AnthropicMessageStreamingDeltaBlock {
    enum Delta: Decodable, Sendable {
        ...
        private enum PossibleTypes: String, Decodable, Sendable {
