...
nonisolated public enum AnthropicImageMediaType: String, Sendable {
...
nonisolated public enum AnthropicInputContent: Encodable, Sendable {
...
nonisolated public struct AnthropicInputMessage: Encodable, Sendable {
    public init(
...
nonisolated public enum AnthropicInputMessageRole: String, Encodable, Sendable {
    case assistant
    case user
}
