...
extension GeminiImagenRequestBody {
    public struct Instance: Encodable {
        ...
        public init(image: GeminiImagenRequestBody.Instance.InputImage? = nil, prompt: String? = nil) {
            self.image = image
            self.prompt = prompt
        }
    }
...
extension GeminiImagenRequestBody.Parameters {
    ...
    public enum SafetyLevel: String, Encodable {
        ...
        /// Reduces the number of requests blocked due to safety filters. May increase objectionable content generated by Imagen. Deprecated value: "block_few".
