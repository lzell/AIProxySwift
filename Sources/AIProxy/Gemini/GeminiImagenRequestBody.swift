...
public struct GeminiImagenRequestBody: Encodable, Sendable {
...
extension GeminiImagenRequestBody {
    public struct Instance: Encodable, Sendable {
...
extension GeminiImagenRequestBody.Parameters {
    ...
    public enum SafetyLevel: String, Encodable, Sendable {
...
extension GeminiImagenRequestBody.Parameters {
    ...
    public enum PersonGeneration: String, Encodable, Sendable {
...
extension GeminiImagenRequestBody.Instance {
    public struct InputImage: Encodable, Sendable {
...
extension GeminiImagenRequestBody.Parameters {
    public struct UpscaleConfig: Encodable, Sendable {
        public enum UpscaleFactor: String, Encodable, Sendable {
            case x2
            case x4
        }
