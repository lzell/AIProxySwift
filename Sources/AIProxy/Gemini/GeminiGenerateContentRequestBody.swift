...
public struct GeminiGenerateContentRequestBody: Encodable, Sendable {
...
extension GeminiGenerateContentRequestBody {
    ...
    public struct GoogleSearch: Encodable, Sendable {
...
extension GeminiGenerateContentRequestBody.Tool {
    ...
    public struct DynamicRetrievalConfig: Encodable, Sendable {
...
extension GeminiGenerateContentRequestBody {
    ...
    public struct ToolConfig: Encodable, Sendable {
...
extension GeminiGenerateContentRequestBody.ToolConfig {
    ...
    public struct FunctionCallingConfig: Encodable, Sendable {
        // Optional
...
extension GeminiGenerateContentRequestBody {
    /// A list of unique SafetySetting instances for blocking unsafe content.
    public struct SafetySetting: Encodable, Sendable {
        public enum SafetyCategory: String, Encodable, Sendable {
        ...
        public enum HarmBlockThreshold: String, Encodable, Sendable {
...
extension GeminiGenerateContentRequestBody {
    /// Developer set system instruction(s). Currently, text only.
    public struct SystemInstruction: Encodable, Sendable {
...
extension GeminiGenerateContentRequestBody.GenerationConfig.SpeechConfig {
    ...
    public enum VoiceName: String, Encodable, Sendable {
        case zephyr = "Zephyr"
        case puck = "Puck"
        case charon = "Charon"
        case kore = "Kore"
