...
public struct GeminiGenerateContentResponseBody: Decodable, Sendable {
...
extension GeminiGenerateContentResponseBody.Candidate.Content {
    ...
    public enum Part: Decodable, Sendable {
        case text(String)
        case functionCall(name: String, args: [String: Sendable]?)
...
extension GeminiGenerateContentResponseBody.Candidate {
    ...
    public struct SafetyRating: Decodable, Sendable {
...
extension GeminiGenerateContentResponseBody.Candidate {
    ...
    public struct GroundingMetadata: Decodable, Sendable {
    ...
    public struct SearchEntryPoint: Decodable, Sendable {
    ...
    public struct GroundingChunk: Decodable, Sendable {
    ...
    public struct WebInfo: Decodable, Sendable {
    ...
    public struct GroundingSupport: Decodable, Sendable {
