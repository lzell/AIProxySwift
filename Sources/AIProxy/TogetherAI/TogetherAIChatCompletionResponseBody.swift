...
public struct TogetherAIChatCompletionResponseBody: Decodable, Sendable {
...
public struct TogetherAIChatCompletionChoice: Decodable, Sendable {
...
public enum TogetherAIFinishReason: String, Decodable, Sendable {
    case eos
    case stop
    case length
...
public struct TogetherAILogprobs: Decodable, Sendable {
...
public struct TogetherAIChatUsage: Decodable, Sendable {
