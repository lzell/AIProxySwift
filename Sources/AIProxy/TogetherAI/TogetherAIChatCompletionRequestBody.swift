...
public struct TogetherAIChatCompletionRequestBody: Encodable, Sendable {
...
public struct TogetherAIMessage: Codable, Sendable {
 ...
 public enum TogetherAIRole: String, Codable, Sendable {
     case assistant
     case system
     case user
 }
...
public enum TogetherAIResponseFormat: Encodable, Sendable {
...
public struct TogetherAITool: Encodable, Sendable {
...
///         ]
///     )
public struct TogetherAIFunction: Encodable, Sendable {
