...
///         input: input
///     )
public struct ReplicateSDXLFreshInkInputSchema: Encodable, Sendable {
...
extension ReplicateSDXLFreshInkInputSchema {
    public enum Refiner: String, Encodable, Sendable {
...
extension ReplicateSDXLFreshInkInputSchema {
    public enum Scheduler: String, Encodable, Sendable {
        case ddim = "DDIM"
