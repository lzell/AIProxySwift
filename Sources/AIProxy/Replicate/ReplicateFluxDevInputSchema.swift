...
public struct ReplicateFluxDevInputSchema: Encodable {
    ...
    public init(prompt: String, aspectRatio: String? = nil, disableSafetyChecker: Bool? = nil, goFast: Bool? = nil, guidance: Double? = nil, image: URL? = nil, numInferenceSteps: Int? = nil, numOutputs: Int? = nil, outputFormat: ReplicateFluxDevInputSchema.OutputFormat? = nil, outputQuality: Int? = nil, promptStrength: Double? = nil, seed: Int? = nil) {
        self.prompt = prompt
