...
public struct ReplicateFluxDevControlNetInputSchema: Encodable, Sendable {
    // Required
...
extension ReplicateFluxDevControlNetInputSchema {
    public enum ControlType: String, Encodable, Sendable {
        case canny
        case depth
...
extension ReplicateFluxDevControlNetInputSchema {
    public enum DepthPreprocessor: String, Encodable, Sendable {
        case midas = "Midas"
        case zoe = "Zoe"
...
extension ReplicateFluxDevControlNetInputSchema {
    public enum SoftEdgePreprocessor: String, Encodable, Sendable {
        case hed = "HED"
        case teed = "TEED"
