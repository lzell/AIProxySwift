...
public struct BraveWebSearchResponseBody: Decodable, Sendable {
...
extension BraveWebSearchResponseBody {
    public struct Mixed: Decodable, Sendable {
        ...
        public struct MixedItem: Decodable, Sendable {
            public let all: Bool
...
extension BraveWebSearchResponseBody.Web.SearchResult {
    public struct MetaURL: Decodable, Sendable {
