...
public struct OpenAIEmbeddingRequestBody: Encodable {
    ...
    public init(input: OpenAIEmbeddingRequestBody.EmbeddingInput, model: String, encodingFormat: OpenAIEmbeddingRequestBody.EncodingFormat? = nil, dimensions: Int? = nil, user: String? = nil) {
        self.input = input
        self.model = model
