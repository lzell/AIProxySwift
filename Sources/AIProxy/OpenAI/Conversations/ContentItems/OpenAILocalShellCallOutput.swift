...
// https://platform.openai.com/docs/api-reference/conversations/create#conversations_create-items-item-local_shell_call_output

/// The output of a local shell tool call.
nonisolated public struct OpenAILocalShellCallOutput: Encodable, Sendable {
