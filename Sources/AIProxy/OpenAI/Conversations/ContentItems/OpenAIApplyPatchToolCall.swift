...
// https://platform.openai.com/docs/api-reference/conversations/create#conversations_create-items-item-apply_patch_tool_call

/// A tool call representing a request to create, delete, or update files using diff patches.
nonisolated public struct OpenAIApplyPatchToolCall: Encodable, Sendable {
