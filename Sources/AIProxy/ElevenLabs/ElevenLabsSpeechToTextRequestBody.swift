...
public struct ElevenLabsSpeechToTextRequestBody: MultipartFormEncodable, Sendable {
    // Required
...
extension ElevenLabsSpeechToTextRequestBody {
    public enum ModelID: String, Encodable, Sendable {
        case scribeV1 = "scribe_v1"
        case scribeV1Experimental = "scribe_v1_experimental"
    }

    public enum TimestampGranularity: String, Encodable, Sendable {
        case none
        case word
        case character
    }
