...
public struct FalFastSDXLInputSchema: Encodable, Sendable {
    // Required
...
extension FalFastSDXLInputSchema {
    public enum ImageSize: String, Encodable, Sendable {
...
extension FalFastSDXLInputSchema {
    public struct LoraWeight: Encodable, Sendable {
        // Required
...
extension FalFastSDXLInputSchema {
    public struct Embedding: Encodable, Sendable {
        // Required
...
extension FalFastSDXLInputSchema {
    public enum SafetyCheckerVersion: String, Encodable, Sendable {
        case v1
        case v2
    }
}
