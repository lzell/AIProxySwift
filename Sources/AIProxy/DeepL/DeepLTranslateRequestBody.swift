...
public struct DeepLTranslateRequestBody: Encodable, Sendable {
    // MARK: Required
...
public enum DeepLFormality: String, Encodable, Sendable {
...
/// Sets whether the translation engine should first split the input into sentences.
public enum DeepLSplitSentencesOption: String, Encodable, Sendable {
    case none = "0"
    case punctuation = "nonewlines"
    case punctuationAndNewlines = "1"
}

public enum DeepLTagHandling: String, Encodable, Sendable {
    case xml
    case xhtml
}
